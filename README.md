...
The [Scdo API](https://github.com/scdoproject/go-scdo/wiki/API-Document#json-rpc-list) is supported as direct methods. Use camelcase and lowercase first letter.
